...
# Import funzioni estrazione specs
from extract_piston_specs import get_piston_specs, map_to_ebay_specifics
...
# Lista pistoni da aggiornare
PISTONI_SKU = ["100-00115"]
    ...
    while page <= total_pages:
        try:
            ...
            if page == 1:
                ...
                logger.info(f"   📊 Totale: {total_entries} inserzioni in {total_pages} pagine")
